...
const sections: {
  ...
  {
    href: '/zh/docs/platform-guide',
    title: '登录平台和使用平台指南',
    description: '注册登录、平台功能与客户端下载。',
    icon: <Compass className="size-5" />,
  },
  {
    href: '/zh/docs/security-credentials',
    title: '安全与凭证管理说明',
    description: '密钥、凭证与权限的安全边界。',
    icon: <ShieldCheck className="size-5" />,
  },
  {
    href: '/zh/docs/agent-building/quickstart',
    title: 'Agent 构建',
    description: '创建、配置并运行你的第一个 Agent。',
    icon: <Bot className="size-5" />,
  },
  {
    href: '/zh/docs/team-usage/quickstart',
    title: '团队使用',
    description: '团队协作、审批、角色与权限管理。',
    icon: <Users className="size-5" />,
  },
  {
    href: '/zh/docs/billing/personal-and-team',
    title: '计费',
    description: '个人、团队与企业版的套餐与定价。',
    icon: <CreditCard className="size-5" />,
  },
  {
    href: '/zh/docs/privacy-and-legal/privacy-policy',
    title: '隐私及法规',
    description: '隐私政策与法律声明。',
    icon: <Scale className="size-5" />,
  },
  {
    href: '/zh/docs/changelog',
    title: '版本更新',
